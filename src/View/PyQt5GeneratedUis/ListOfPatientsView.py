...
class UiListOfPatients(object):
    def setupUi(self, Form):
        ...
        self.allPatientListWidget = QtWidgets.QListWidget(Form)
        self.allPatientListWidget.setGeometry(QtCore.QRect(10, 40, 381, 192))
        self.allPatientListWidget.setObjectName("allPatientListWidget")
