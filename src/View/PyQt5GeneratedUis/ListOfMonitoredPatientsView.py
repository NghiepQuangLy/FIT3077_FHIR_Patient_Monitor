...
class UiListOfMonitoredPatients(object):
    def setupUi(self, Form):
        ...
        self.monitoredPatientListWidget = QtWidgets.QListWidget(Form)
        self.monitoredPatientListWidget.setGeometry(QtCore.QRect(10, 40, 381, 192))
        self.monitoredPatientListWidget.setObjectName("monitoredPatientListWidget")
