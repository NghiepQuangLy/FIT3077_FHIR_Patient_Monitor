...
class CustomPatientListItemWidget(QtWidgets.QWidget):
    ...
    def __init__(self, patient_name: str, action: str, callback_func, unique_id: str, measurement_value: str):
        super().__init__()
        patient_list_item_label = QtWidgets.QLabel(patient_name)
        patient_list_item_value = QtWidgets.QLabel(measurement_value)
        ...
        patient_list_item_layout.addWidget(patient_list_item_value)
